...
A full-stack real-time communication platform built with **Angular**, **ASP.NET Core Web API**, **SignalR**, and **WebRTC**.

---

## Overview

This project is a real-time chat application that supports:
